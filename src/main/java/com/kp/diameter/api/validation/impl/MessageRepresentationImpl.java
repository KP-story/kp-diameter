...
public class MessageRepresentationImpl implements MessageRepresentation {
    ...
    @Override
    public void validate(IDMessage msg, ValidatorLevel validatorLevel) throws AvpNotAllowedException {
